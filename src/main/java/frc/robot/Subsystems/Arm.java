...
public class Arm extends SubsystemBase {
    ...
    // Singleton pattern ensures only one instances exists in program
    ...
    private Arm() {
        ...
        m_armLeaderConfigurator.apply(currentLimits);
        m_armFollowerConfigurator.apply(currentLimits);
        ...
        m_armLeaderConfigurator.apply(actuationLimits);
        m_armLeaderConfigurator.apply(actuationLimits);
        ...
        m_armLeaderConfigurator.apply(feedbackConfig);
        ...
        Slot1Configs descentConfig = new Slot1Configs() // TODO: figure out proper values
            ...
            .withKI(0.0)
            .withKD(0.0);
        m_armLeaderConfigurator.apply(ascentConfig);
        m_armLeaderConfigurator.apply(descentConfig);
    ...
    public void moveTo(double degrees) {
        ...
        m_armTalonLeader.setControl(m_positionControlReqeust
            .withSlot(whichSlot)
    ...
    public void kill() {
        m_armTalonLeader.disable();
        m_armTalonFollower.disable();
    }
